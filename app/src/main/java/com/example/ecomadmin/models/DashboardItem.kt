...
val dashboardItemList = listOf<DashboardItem>(
    ...
    DashboardItem(icon = R.drawable.ic_baseline_supervised_user_circle_24, title = "Manage Users", type = DashboardItemType.USER),
    DashboardItem(icon = R.drawable.ic_baseline_settings_24, title = "Settings", type = DashboardItemType.SETTINGS)
)
